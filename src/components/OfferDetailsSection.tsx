...
export const OfferDetailsSection: React.FC = () => {
  const mainProductBenefits = [
    ...
    "Mais de 200 Receitas de café da manhã, almoço, café da tarde e jantar",
  ...
  const bonuses = [
    {
      ...
      image: "/1-768x922.webp"
    },
    {
      number: "#2",
      title: "Incentive seu filho a aceitar novos alimentos através do lúdico",
      description: "Estratégias criativas e brincadeiras que transformam a hora da refeição em diversão, ajudando crianças resistentes a experimentar e aceitar novos alimentos.",
      image: "/3-768x922.webp"
    },
    {
      number: "#3",
      title: "Manual de como montar lancheiras na prática",
      description: "Guia completo com combinações balanceadas, dicas de organização e ideias rápidas para montar lancheiras nutritivas, práticas e atrativas.",
      image: "/4-768x922.webp"
    },
    {
      number: "#4",
      title: "Receitas especiais para crianças com alergias",
      description: "Seleção exclusiva de receitas adaptadas para as alergias alimentares mais comuns (leite, ovo, soja, amendoim), garantindo segurança e sabor.",
      image: "/5-768x922.webp"
    },
    {
      number: "#5",
      title: "Guia de Congelamento e Organização das receitas",
      description: "Técnicas eficientes de congelamento e um sistema prático de planejamento semanal que economiza tempo e dinheiro.",
      image: "/6-768x922.webp"
    }
  ];
