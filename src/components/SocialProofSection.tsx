...
export const SocialProofSection: React.FC = () => {
  ...
  const testimonials = [
    {
      id: 0,
      image: "/BISCOITINHO-768x1365.webp",
      text: "Os biscoitinhos caseiros foram um sucesso! Meu filho adora e eu fico tranquila sabendo que é saudável.",
      author: "Ana C., mãe do Pedro"
    },
    {
      id: 1,
    ...
    {
      id: 4,
      image: "/BANANA-768x1365.webp",
      text: "As receitas com banana são incríveis! Minha filha que não gostava de fruta agora pede mais.",
      author: "Fernanda L., mãe da Júlia"
    },
    {
      id: 5,
      image: "/ANA-MARIA-768x1365.webp",
      text: "Que descoberta maravilhosa! As receitas são práticas e os resultados surpreendentes. Recomendo!",
      author: "Ana Maria R., avó da Beatriz"
    },
    {
      id: 6,
      image: "/BOLINHA-768x1365.webp",
      text: "As bolinhas nutritivas são o lanche favorito do meu filho! Fácil de fazer e super saudável.",
      author: "Patrícia M., mãe do Gabriel"
    },
    {
      id: 7,
      image: "/PAOZINHO-768x1365.webp",
      text: "Os pãezinhos caseiros ficaram perfeitos! Agora faço em casa com ingredientes saudáveis.",
      author: "Roberta S., mãe da Amanda"
    },
    {
      id: 8,
      image: "/PIZZA-768x1365.webp",
      text: "Pizza saudável que as crianças adoram! Finalmente uma receita que une sabor e nutrição.",
      author: "Camila T., mãe do Mateus"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-fredoka font-bold text-orange-primary mb-4">
            O que as mamães estão falando
          </h2>
          <p className="text-xl text-gray-primary font-nunito">
            Veja os resultados de quem já transformou a alimentação dos pequenos com o nosso guia!
          </p>
        </div>
